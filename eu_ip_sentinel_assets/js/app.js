...
const i18n = {
  zh: {
    ...
    nav_settings: '设置',
    nav_about: '前哨说明',
    topbar_sub_news: '首页先看总揽、今日发布、当前战报与专题，再进入情报流。',
    topbar_sub_reports: '先看两份当前战报和 20 条可追溯明细，再回看最近几期与历史归档。',
    topbar_sub_sources: '查看当前窗口内真正活跃的来源、相关性与原文质量。',
    topbar_sub_stats: '值守抓取、质检、AI分析与异常来源，快速判断链路是否稳定。',
    topbar_sub_about: '查看前哨的定位、信息源、加工链路与 AI 精度机制。',
    ...
    stats_overview_desc: '查看当前观察窗口、自动任务、抓取、质检与 AI 解读的整体状态。',
    ...
    section_reports: '当前战报',
    section_reports_desc_home: '首页先看当前日报与周报；详细要点默认折叠，完整 20 条明细、最近几期与历史归档都在战报中心。',
    section_reports_desc_page: '先看当前窗口最重要的两份战报和 20 条可追溯明细，再往下看最近几期的连续变化。',
    ...
    section_latest_dynamics: '最新动态速读',
    ...
    reports_open_center: '进入战报中心查看完整战报',
    reports_open_center_short: '查看完整战报',
    reports_center_title: '战报中心',
    reports_center_desc: '围绕当前两份战报、20 条可追溯明细、最近几期与历史归档组织整个战报流，便于持续跟踪盘面变化。',
    ...
    report_items_title: '战报明细',
    report_items_desc: '围绕当前战报列出最多 10 条可直接下钻的具体资讯。',
    ...
    report_items_preview_more: '进入战报中心查看全部 10 条',
    ...
    reports_archive_open_brief: '打开战报',
    ...
    about_title: '前哨说明',
    about_subtitle: '了解前哨的定位、信息源、加工链路与稳定输出机制',
    about_purpose_kicker: '前哨定位',
    about_purpose_title: '前哨想解决什么问题',
    about_purpose_desc: '前哨不是简单的资讯聚合页，而是面向欧洲知识产权领域的持续观察系统。它优先关注官方机构、法院、专业媒体与律所的高价值动态，目标是帮助使用者更快获得及时、全面、去噪后的欧洲 IP 情报，并形成可执行的分析视角。',
    ...
    about_workflow_title: '前哨如何获取、加工并呈现情报',
    ...
    about_sources_title: '前哨覆盖哪些信息源',
    about_sources_desc: '信息源分为官方、媒体、律所三类；以下优先展示当前窗口内实际产生资讯的来源。',
    ...
    about_method_intro: '前哨不是把文章直接交给 AI 自由发挥，而是用“规则底座 + AI 编辑标注 + 服务端归一化 + 质量守卫”的方式，尽量压低误判、漂移和噪音回流。',
